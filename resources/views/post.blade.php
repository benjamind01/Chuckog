    ...
    <body class="flex flex-row mt-12 mx-auto justify-center">
        <div class="w-3/5 mb-12">
            <div class="bg-white shadow-md border border-gray-200 rounded-lg max-w-[90%] mx-auto mb-5">
                <div class="p-5">
                    <a href="{{ route('home.index') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mb-5">
