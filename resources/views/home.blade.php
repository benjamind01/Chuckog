...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="flex flex-col mt-12 mx-auto justify-center items-center w-full">
        <h1 class="font-bold text-5xl">Chuckog</h1>
        <div class="flex flex-row mt-12 mx-auto justify-center w-full">    
            <div class="w-3/5 mb-12 ml-6">
